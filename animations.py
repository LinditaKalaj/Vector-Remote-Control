...
class Animations(ctk.CTkFrame):
    ...
    def attach_buttons(self):
        ...
        self.greet.grid(row=0, column=0, pady=15)
        self.frustrated.grid(row=0, column=1, pady=15)
        self.owo_sad.grid(row=0, column=2, pady=15)
        self.ring.grid(row=0, column=3, pady=15)
        self.sleepy.grid(row=0, column=4, pady=15)
        self.hehe.grid(row=0, column=5, pady=15)
        self.woa.grid(row=0, column=6, pady=15)
